...
export const ENCOUNTERS: EncounterDef[] = [
  {
    ...
    enemyId: "salt-wight",
    durationRoundSeconds: 30,
    goldReward: 9,
    itemPool: ["shore-sandals", "warlock-ring", "field-bandage"],
    itemChance: 0.38,
    gemChance: 0.14,
  ...
  },
  {
    ...
    enemyId: "ashjackal",
    durationRoundSeconds: 25,
    goldReward: 10,
    itemPool: ["market-boots", "herald-gloves", "field-bandage"],
    itemChance: 0.36,
    gemChance: 0.15,
    minStoryFlags: ["shore_unlocked"],
  },
  ...
  },
  {
    ...
    durationRoundSeconds: 28,
    goldReward: 11,
    itemPool: ["herald-gloves", "shore-sandals", "shore-tonic"],
    itemChance: 0.35,
    gemChance: 0.16,
    minStoryFlags: ["canyon_unlocked"],
  },
  ...
  },
  {
    ...
    durationRoundSeconds: 35,
    goldReward: 17,
    itemPool: ["canyon-amulet", "ash-helm", "ash-draught"],
    itemChance: 0.42,
    gemChance: 0.24,
