...
export const RECIPES: RecipeDef[] = [
  ...
  },
  {
    id: "smoke-fish-crate",
    skill: "cooking",
    name: "Smoke fish crate",
    description:
      "Fill the smoke rack with a full crate. Converts raw catch into road-ready fillets.",
    levelReq: 4,
    durationSeconds: 55,
    xp: 14,
    repeatable: true,
    inputs: [
      { materialId: "raw-fish", amount: 6 },
      { materialId: "apple-wood", amount: 2 },
    ],
    outputMaterialId: "cooked-fish",
    outputAmount: 5,
  },
  {
    id: "batch-shore-tonic",
    skill: "cooking",
    name: "Batch shore tonic",
    description:
      "Boil a pot for the square stalls. Repeatable kitchen work that eats fish and herbs.",
    levelReq: 7,
    durationSeconds: 65,
    xp: 20,
    repeatable: true,
    inputs: [
      { materialId: "cooked-fish", amount: 4 },
      { materialId: "herb-bundle", amount: 3 },
    ],
    outputItemId: "shore-tonic",
    outputAmount: 2,
  },
  {
    id: "pack-trail-rations",
    skill: "cooking",
    name: "Pack trail rations",
    description:
      "Wrap fish and reeds for ford walkers. Cheap heals — low sell value keeps them on the road.",
    levelReq: 8,
    durationSeconds: 70,
    xp: 22,
    repeatable: true,
    inputs: [
      { materialId: "cooked-fish", amount: 4 },
      { materialId: "pale-reed", amount: 2 },
      { materialId: "herb-bundle", amount: 2 },
    ],
    outputItemId: "trail-ration",
    outputAmount: 4,
  },
  {
    id: "brew-ash-draught",
    skill: "cooking",
    name: "Brew ash draught",
    description:
      "Tablelands bitters from ash ore and rare scales. Heavy heal — burns premium materials.",
    levelReq: 10,
    durationSeconds: 80,
    xp: 26,
    repeatable: true,
    inputs: [
      { materialId: "ash-ore", amount: 2 },
      { materialId: "herb-bundle", amount: 3 },
      { materialId: "silver-scale", amount: 2 },
    ],
    outputItemId: "ash-draught",
    outputAmount: 2,
  },
  {
    id: "smelt-copper",
  ...
  },
  {
    id: "bulk-smelt-iron",
    skill: "smithing",
    name: "Bulk smelt iron",
    description:
      "Run another furnace batch. Ore and coal in, bars out — millwrights pay for steady output.",
    levelReq: 8,
    durationSeconds: 75,
    xp: 18,
    repeatable: true,
    inputs: [
      { materialId: "iron-ore", amount: 4 },
      { materialId: "coal", amount: 2 },
    ],
    outputMaterialId: "iron-bar",
    outputAmount: 2,
    locationId: "stone-mill",
  ...
  {
    id: "forge-iron-plates",
    skill: "smithing",
    name: "Forge iron plates",
    description:
      "Hammer bars into plate stock. Repeatable forge work that eats bars and coal.",
    levelReq: 10,
    durationSeconds: 85,
    xp: 22,
    repeatable: true,
    inputs: [
      { materialId: "iron-bar", amount: 3 },
      { materialId: "coal", amount: 2 },
    ],
    outputMaterialId: "iron-plate",
    outputAmount: 2,
    locationId: "stone-mill",
  },
  {
    id: "refine-ash-alloy",
    skill: "smithing",
    name: "Refine ash alloy",
    description:
      "Fold ash ore into iron at the wheel forge. Slow, hot, and hungry for coal.",
    levelReq: 12,
    durationSeconds: 95,
    xp: 26,
    repeatable: true,
    ...
    outputMaterialId: "ash-alloy",
    outputAmount: 1,
    locationId: "stone-mill",
  },
  {
    id: "forge-iron-greaves",
    skill: "smithing",
    name: "Forge iron greaves",
    description:
      "Rivet plate onto leather straps. Good gear — or sell the pair for coin.",
    levelReq: 13,
    durationSeconds: 100,
    xp: 28,
    repeatable: true,
    inputs: [
      { materialId: "iron-bar", amount: 3 },
      { materialId: "iron-plate", amount: 2 },
      { materialId: "coal", amount: 1 },
    ],
    outputItemId: "iron-greaves",
    outputAmount: 1,
    locationId: "stone-mill",
  },
  {
    id: "forge-herald-blade",
    skill: "smithing",
    name: "Forge herald blade",
    description:
      "Ash alloy edge on an iron core. Repeatable high-tier smithing for fighters and traders.",
    levelReq: 15,
    durationSeconds: 110,
    xp: 32,
    repeatable: true,
    inputs: [
      { materialId: "iron-bar", amount: 2 },
      { materialId: "ash-alloy", amount: 2 },
      { materialId: "apple-wood", amount: 2 },
    ],
    outputItemId: "herald-blade",
    outputAmount: 1,
    locationId: "stone-mill",
  },
  {
    id: "forge-reinforced-vest",
    skill: "smithing",
    name: "Forge reinforced vest",
    description:
      "Layer ash alloy over plate. Burns gem chips for tempering — a true material sink.",
    levelReq: 16,
    durationSeconds: 120,
    xp: 36,
    repeatable: true,
    inputs: [
      { materialId: "ash-alloy", amount: 3 },
      { materialId: "iron-plate", amount: 2 },
      { materialId: "gem-chip", amount: 1 },
    ],
    outputItemId: "reinforced-vest",
    outputAmount: 1,
    locationId: "stone-mill",
  },
];
