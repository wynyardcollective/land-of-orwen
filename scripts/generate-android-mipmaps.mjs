/**
 * Resize public/icons/icon-512.png into Android mipmap launcher icons.
 * Run from repo root: node scripts/generate-android-mipmaps.mjs
 */
...
console.log("Android mipmap icons updated from public/icons/icon-512.png");
